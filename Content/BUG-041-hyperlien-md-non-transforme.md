## BUG-041 un hyperlien en extension md n’est pas traduit en extension html lors de la transformation md html
...
- événement : au clic sur le lien en extension .md, on aboutit à une erreur 404
