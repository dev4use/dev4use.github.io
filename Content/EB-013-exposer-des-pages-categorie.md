# EB-012 exposer des pages de listing catégorie

- Besoin : disposer de pages par catégorie, le problème se pose(ra) avec un nombre élevé de posts par catégorie rendant l'affichage en menu de header pénible aux yeux
